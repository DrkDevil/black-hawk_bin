class ActionEnableLightHeliCB_black_hawk : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightSIB_black_hawk: ActionContinuousBase
{
	void ActionHeliEnableLightSIB_black_hawk()
	{
		m_CallbackClass = ActionEnableLightHeliCB_black_hawk;
