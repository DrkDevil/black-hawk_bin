class ActionDisableLightPanelHeliCB_black_hawk : ActionContinuousBaseCB
{
...
class ActionHeliDisableLightPanelSIB_black_hawk: ActionContinuousBase
{
	void ActionHeliDisableLightPanelSIB_black_hawk()
	{
		m_CallbackClass = ActionDisableLightPanelHeliCB_black_hawk;
